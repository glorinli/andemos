...
public class HoleViewPathEvenOdd extends View {
    ...
    public HoleViewPathEvenOdd(Context context) {
        super(context);
        initView();
    }

    public HoleViewPathEvenOdd(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public HoleViewPathEvenOdd(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
